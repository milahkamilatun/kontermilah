            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col col-sm-3">
                        <a href="http://localhost:8080/kontermilah/views/pembelian/add.php" class="btn btn-success btn-sm float-end">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" id="sample_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="supplier" name="supplier" id="supplier" class="form-control" />
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#grand_total').val(response.grand_total).change();
            },
            error: function(err) {
                console.log(err);
            }
